...
<head>
    ...
    <title>United Scale-Tank Weighing System</title>
...
<?php  include 'header.php';  ?>    
    ...
    <h1 style="padding-top: 20px; color: gray; text-align:center; font-family: 'Courgette', cursive;">Tank Weighing System</h1>
    <center>
      <div class="searchdiv">
...
$select="SELECT * FROM subproducts where subptypeid=5";
