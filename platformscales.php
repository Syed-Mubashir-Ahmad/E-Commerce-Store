...
<head>
    ...
    <title>United Scale-Platform Scale</title>
...
<?php  include 'header.php';  ?>    
    ...
    <h1 style="padding-top: 20px; color: gray; text-align:center; font-family: 'Courgette', cursive;">Platform Scale</h1>
    <center>
      <div class="searchdiv">
...
$select="SELECT * FROM subproducts where subptypeid=7";
