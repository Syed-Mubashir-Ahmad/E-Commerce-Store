...
<head>
    ...
    <title>United Scale-Tensile Testing</title>
...
<?php  include 'header.php';  ?>    
    ...
    <h1 style="padding-top: 20px; color: gray; text-align:center; font-family: 'Courgette', cursive;">Tensile Testing</h1>
    <center>
      <div class="searchdiv">
...
$select="SELECT * FROM subproducts where subptypeid=6";
